...
Open `http://127.0.0.1:8000/`. Double-click anywhere to create a user node, enter a question, and press “发送”. The backend calls `gpt-5-mini` and renders the AI response in a new node.